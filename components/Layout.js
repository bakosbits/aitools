...
export default function Layout({ children }) {
    return (
        <div className="bg-gray-800 min-h-screen flex flex-col">
            {/* Header */}
            <header className="fixed top-0 left-0 right-0 z-50 bg-gray-800 border-b border-gray-600 flex items-center justify-between">
                {/* Unified Header */}
                <div className="w-full px-4 py-4 flex items-center justify-between">
                    <Link
                        href="/"
                        className="text-gray-300 text-3xl font-bold hover:text-blue-500 transition-colors duration-150 tracking-tighter"
                    >
