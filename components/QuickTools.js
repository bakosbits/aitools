    ...
    <div className="w-full p-6 space-y-4 bg-cardDark rounded-lg shadow-lg border border-gray-600">
      ...
      <div className="flex flex-wrap gap-2 bg-cardDark">
        {selectedTool && selectedTool.memo && (
          <p className="px-2 text-sm text-gray-300">{selectedTool.memo}</p>
        )}
      </div>
      {/* Input */}
      <textarea
        ...
        className="w-full p-3 border border-gray-600 bg-backgroundDark text-gray-400 rounded-lg mb-4"
        rows={5}
      ...
      {output && (
        <div className="relative mt-6">
          ...
          <div className="p-4 border border-gray-600 bg-backgroundDark text-gray-400 rounded-lg whitespace-pre-wrap pt-10">
            {output}
          </div>
        </div>
      )}
