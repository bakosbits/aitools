...
export const getBaseSchema = (categoryNames, useCaseTags, cautionTags) => ({
    Name: {
        type: "STRING",
...
export const getToolCategoriesSchema = (availableCategories) => ({
    Categories: {
        ...
        description:
            "Required - An array of 1 to 2 relevant categories that this tool is designed for, selected ONLY from the provided list.",
    },
});
...
export const getUseCasesSchema = () => ({
    UseCases: {
        type: "ARRAY",
        description:
            "Required - An array of 5 use cases and tags for the tool.",
        items: { type: "STRING" },
    },
});
...
export const getComparisonAnalysisSchema = () => ({
    toolA_name: {
        type: "STRING",
        description: "The name of the first tool",
    },
    toolB_name: {
        type: "STRING",
        description: "The name of the second tool.",
    },
    toolA_strengths: {
        type: "ARRAY",
        items: { type: "STRING" },
        description: "A list of key strengths for the first tool.",
    },
    toolB_strengths: {
        type: "ARRAY",
        items: { type: "STRING" },
        description: "A list of key strengths for the second tool.",
    },
    comparative_summary: {
        type: "STRING",
        description: "A concise summary comparing both tools and recommending which is better for specific scenarios or user types.",
    },
});

export const getToolRecommendationSchema = () => ({
    recommendedTool: {
        type: "STRING",
        description: "Required - The name of the recommended tool",
    },
    reasons: {
        type: "ARRAY",
        items: { type: "STRING" },
        description: "Required - 3-4 specific reasons why this tool is the best match for the user's needs",
    },
    limitations: {
        type: "ARRAY",
        items: { type: "STRING" },
        description: "Required - 1-2 potential limitations or considerations the user should be aware of",
    },
    alternatives: {
        type: "ARRAY",
        items: {
        ...
        description: "Required - 1-2 alternative tools that could also meet the user's needs, with their key benefits",
    }
});
