...
const {
  ...
  AIRTABLE_USECASES_TABLE,
  AIRTABLE_MODALITIES_TABLE,
  AIRTABLE_TAGS_TABLE,
  AIRTABLE_PREFERENCES_TABLE,
} = process.env;
...
if (
  ...
  if (!AIRTABLE_USECASES_TABLE)
    console.error("   - AIRTABLE_USE-CASES_TABLE is missing.");
  if (!AIRTABLE_MODALITIES_TABLE)
    console.error("   - AIRTABLE_MODALITIES_TABLE is missing.");
  if (!AIRTABLE_TAGS_TABLE)
    console.error("   - AIRTABLE_TAGS_TABLE is missing.");
  if (!AIRTABLE_PREFERENCES_TABLE)
    console.error("   - AIRTABLE_PREFERENCES_TABLE is missing.");
...
export const useCasesTable = base(process.env.AIRTABLE_USECASES_TABLE);
export const modalitiesTable = base(process.env.AIRTABLE_MODALITIES_TABLE);
export const tagsTable = base(process.env.AIRTABLE_TAGS_TABLE);
export const preferencesTable = base(process.env.AIRTABLE_PREFERENCES_TABLE);
