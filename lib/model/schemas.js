...
export const getBaseSchema = (categoryNames, tagNames) => ({
    ...
    Tags: {
        ...
        description:
            "Select 3 to 7 relevant tags for the tool, selected ONLY from the provided tagNames list.",
    },
    Categories: {
        type: "ARRAY",
        items: {
...
export const getToolTagsSchema = () => ({
    Tags: {
        ...
        description: "Select ONLY between 3-7 relevant tags from teh provided list."
    }
});
...
export const getGenericTagsSchema = () => ({
    Tags: {
        ...
        description: "Select ONLY between 2-10 relevant tags from teh provided list."
    }
});
