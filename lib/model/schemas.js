...
export const getToolTagsSchema = () => ({
    Tags: {
        ...
        description:
            "Required - Select ALL relevant tags from the provided list.",
    },
});
...
export const getUseCasesSchema = () => ({
    Tool: {
        type: "STRING",
        description:
            "Required - The name of the tool that the use case belongs to.",
    },
    "Use Case": {
        type: "STRING",
        description: "Required - The Use Case that this tool addresses.",
    },
});
...
export const getCompareAnalysisSchema = () => ({
    Analysis: {
        type: "STRING",
        description: "Required - A concise analysis and summary of the comparison between two AI tools.",
    },
});
