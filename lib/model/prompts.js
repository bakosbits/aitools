...
`;
        ...
        examplesContext = `Review the Description, Details, and Why fields of the following tools:\n${formattedTools}\n`;
    }

    const prompt = `You are an ${persona}. Analyze the ${entityType} named "${entity.Name}".
Based on your analysis, select the most appropriate tags that would associate with the ${entityType}.
Use the following context when selecting tags for ${entityType}.
...
3. You MUST select between ${minTags} and ${maxTags} tags
