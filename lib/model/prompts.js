 ...
 * @returns {string} The complete, formatted prompt string.
 */
export const mapCategoriesPrompt = (tool, availableCategories, toolFeatures) => {
...
export const createToolResearchPrompt = (tool,availableCategories, availableUseCaseTags, availableCautionTags) => {
...
Available Use Case Tags:
${availableUseCaseTags.join("\n")}

Available Caution Tags:
