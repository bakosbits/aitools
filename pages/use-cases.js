        ...
        <>
            ...
            <div className="w-full lg:w-[90%] mx-auto grid grid-cols-1 md:grid-cols-[30%_70%] gap-6">
                ...
                <div className="flex flex-col">
                    ...
                    {/* Preferences */}
                    <h2 className="text-lg font-bold mb-2">
                        ⚙️ Do you have preferences or constraints you&apos;d
                        like to add?
                    </h2>
                    <div className="w-full text-gray-400 border border-gray-600 p-4 rounded-lg bg-cardDark mb-6">
                                ...
                                <>
                                    ...
                                    <div className="w-full border border-gray-600 p-6 rounded-lg bg-cardDark">
                                        <p>
                                            ...
                                            to get started. You&apos;re not
                                            required to answer every question.
                                            Each question can have multiple
                                            answers. Apply as many filters in
                                            any combination you wish, but
                                            remember - The amount of context you
                                            add impacts the results. Enjoy.
                                        </p>
                                    </div>
                                </>
                            )}
