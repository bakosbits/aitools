  ...
  return (
    <>
      ...
      >
        ...
        <h2 className="text-xl tfont-semibold mb-1">Content Accuracy</h2>
        ...
        <h2 className="text-xl font-semibold mb-1">Use of Site</h2>
        <p className="mb-4 text-gray-400">
          You agree to use AI Tool Pouch for lawful purposes only. You may not
        ...
        <h2 className="text-xl font-semibold mb-1">Changes to These Terms</h2>
