...
export async function getServerSideProps({ req, res, params }) {
  ...
  if (req.method === "POST") {
    try {
      ...
      return { props: { error: `Failed to update article: ${error.message}` } };
    }
  }
  ...
  try {
    ...
    return { props: { error: `Failed to fetch article: ${error.message}` } };
  }
}
...
export default function EditArticlePage({ article, error }) {
  ...
  return (
    <div className="w-full md:w-[75%] mx-auto">
      ...
      <h1 className="text-3xl font-bold text-slate-300 mb-6">Edit Article</h1>
