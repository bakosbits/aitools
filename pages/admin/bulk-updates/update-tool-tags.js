...
export default function UpdateTagsPage() {
    ...
    const handleStartUpdate = () => {
        ...
        const eventSource = new EventSource(`/api/bulk-update-tool-tags?model=${model}`);
    ...
    return (
        <div className="flex items-center justify-center py-12">
            <div className="w-full max-w-2xl p-8 space-y-6 bg-cardDark rounded-lg border border-gray-600">
                ...
                <p className="mb-4">
                    This process uses AI to analyze each tool.
                    It will iterate over every tool, 
                    analyze its purpose, and select 3-7
                    of the most relevant tags to assign to it. The
                    existing tags for each tool will be overwritten.
                </p>
