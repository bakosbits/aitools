    ...
    return (
        <div className="flex items-center justify-center py-12">
            <div className="w-full max-w-2xl p-8 space-y-6 bg-cardDark rounded-lg border border-gray-600">
                ...
                <h1 className="text-2xl font-bold mb-2">Map Caution Tags</h1>
                <p className="mb-4">
                    This process uses AI to Analyze cations. It will iterate
                    over every tool, analyze its cautions, and select the most
                    relevant tags to assign to it. The existing tags for each
                    too will be overwritten.
                </p>
