...
export default function UpdateToolCategories() {
    ...
    const { statusLog, error, isLoading, startStream } = usePersistentSSE({
        url: `/api/admin/bulk-updates/map-tool-categories?model=${model}`,
    });
        ...
        <div className="flex items-center justify-center py-12">
            <div className="w-full max-w-2xl p-8 space-y-6 bg-cardDark rounded-lg border border-gray-600">
                ...
                <h1 className="text-2xl font-bold mb-2">
                    Bulk Update Tool Categories
                </h1>
                <p>
                    This process uses AI analyze each tool. It will iterate over
                    every tool, analyze its purpose, and assign it to1 - 3 of
                    the most relevant categories. The existing tags for each use
                    case will be overwritten.
                </p>
