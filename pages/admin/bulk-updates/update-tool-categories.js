...
export default function UpdateToolCategories() {
  ...
  const handleStartUpdate = () => {
    ...
    const eventSource = new EventSource(
      `/api/bulk-update-tool-categories?model=${model}`,
    );
  ...
  return (
    <div className="flex items-center justify-center py-12">
      <div className="w-full max-w-2xl p-8 space-y-6 bg-cardDark rounded-lg border border-gray-600">
        ...
        <p>
          This process uses AI analyze each tool. It will iterate over every
          tool, analyze its purpose, and assign it to1 - 3 of the most relevant
          categories. The existing tags for each use case will be overwritten.
        </p>
