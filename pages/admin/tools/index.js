    ...
    <div className="w-full w-[80%] mx-auto">
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full leading-normal">
          <thead>
            <tr>
              <th className="px-5 py-3 bg-gray-800 text-left text-xs font-semibold text-slate-300 uppercase tracking-wider">
                Name
              </th>
              <th className="px-5 py-3 bg-gray-800 text-left text-xs font-semibold text-slate-300 uppercase tracking-wider">
                Website
              ...
              <th className="px-5 py-3 bg-gray-800 text-right text-xs font-semibold text-slate-300 uppercase tracking-wider">
                Actions
              </th>
            </tr>
          </thead>
            ...
            {tools.map((tool) => (
              ...
              >
                ...
                <td className="px-5 py-4 text-sm">
                  <span
                    className={`px-2 py-1 rounded-full text-xs font-semibold ${tool.Active ? "bg-teal-600 text-slate-100" : "bg-yellow-200 text-yellow-800"}`}
                  >
